...
class Cart_ASP(unittest.TestCase):

    def setUp(self):
       self.driver = webdriver.Chrome()

    def test_add_sale_price(self):
        user = "instructor"
        pwd = "instructor1a"
        driver = self.driver
        ...
        time.sleep(1)
        driver.find_element_by_id("id_form-2-regular_price").send_keys("44.50")
        blank = driver.find_element_by_id("id_form-2-price")
        blank.clear()
        driver.find_element_by_id("id_form-2-price").send_keys("39.99")
